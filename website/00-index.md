...
Предлагаю попробовать и (при желании) приобрести отечественную платную версию базы данных на основе популярной и широко используемой в мире <a href="//licenses.ru/software/diasoft/databases/postgresql/">PostgreSQL</a>. База зарегистрирована в реестре отечественно ПО, прошла сертификацию ФСТЕК и разрешенна для установки на любые сервера компаний без ограничений. 
